...
function changeContent(segment){
    ...
    if (segment === "comerciante"){
        ...
        <a href=https://ayni-webapp.netlify.app/signin class="ui-component-button ui-component-button-big ui-component-button-primary" role="link" aria-label="#">Start now</a>
        `;
        const func_2 = `
        ...
        <span><strong>Crop planner</strong></span>
              ...
              <a href=https://ayni-webapp.netlify.app/signin class="ui-component-button ui-component-button-big ui-component-button-secondary" role="link" aria-label="#">Start now</a>
        `;
        const func_2 = `
